...
export interface IWorldInterface extends utils.Interface {
  functions: {
    ...
    "reassign(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "compost", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "deploySpecies",
    values: [
  ...
  decodeFunctionResult(functionFragment: "plantSeed", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "popFromField(bytes16,bytes16,bytes32[],uint8,uint256)",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "reassign", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "registerFunctionSelector",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "waterable", data: BytesLike): Result;
...
export interface IWorld extends BaseContract {
  ...
  functions: {
    ...
    deploySpecies(
      ipfsRootHash: PromiseOrValue<string>,
      symbol: PromiseOrValue<string>,
      name: PromiseOrValue<string>,
      mintPrice: PromiseOrValue<BigNumberish>,
      growthCycleBlocks: PromiseOrValue<BigNumberish>,
      lifecycleLength: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    plantSeed(
      plot: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    compost(overrides?: CallOverrides): Promise<void>;
